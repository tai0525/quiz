...
function showQuestions(index) {
  ...
  let total_queTag = '<p>' + questions[index].numb + ' Of 50 </p>'
...
function showResultBox() {
  ...
  if (userScore > 47) {
    let scoreTag = '<span>升級成郵輪!!! <p>' + userScore + '</p> Out Of <p>' + questions.length + '</p></span>';
    scoreText.innerHTML = scoreTag;
  }
  else if (userScore >= 42) {
    let scoreTag = '<span>小船變遊艇 You Got <p>' + userScore + '</p> Out Of <p>' + questions.length + '</p></span>';
    scoreText.innerHTML = scoreTag;
  }
  else if (userScore >= 37) {
    let scoreTag = '<span>484偷開外掛 You Got <p>' + userScore + '</p> Out Of <p>' + questions.length + '</p></span>';
    scoreText.innerHTML = scoreTag;
  }
  else if (userScore >= 32) {
    let scoreTag = '<span>居然有一半! You Got <p>' + userScore + '</p> Out Of <p>' + questions.length + '</p></span>';
    scoreText.innerHTML = scoreTag;
  }
  else if (userScore >= 27) {
    let scoreTag = '<span>船底破了洞 You Got <p>' + userScore + '</p> Out Of <p>' + questions.length + '</p></span>';
    scoreText.innerHTML = scoreTag;
  }
  else {
    let scoreTag = '<span>小船沉了QQ You Got <p>' + userScore + '</p> Out Of <p>' + questions.length + '</p></span>';
